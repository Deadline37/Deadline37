...
| :--- | :--- | :--- | :--- |
| **Чек-листы и тест-кейсы** | Примеры тестовой документации для разных типов функциональности (веб, мобильное приложение). | `Test IT` `Excel` | [Смотреть →](https://drive.google.com/your-link) |
